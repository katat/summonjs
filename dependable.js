...
(function() {
  ...
  exports.container = function() {
    ...
    get = function(name, overrides, visited) {
      var dependencies, factory, instance, isOverridden, module, prototypeNames;
      if (visited == null) {
        visited = [];
      }
      ...
      prototypeNames = Object.keys(factory.func.prototype);
      if (prototypeNames.length > 0) {
        instance = factory.func.apply(Object.create(factory.func.prototype), dependencies);
      } else {
